...
class PaymentMethodBottomSheet extends StatefulWidget {
  ...
  const PaymentMethodBottomSheet({Key? key, required this.totalPrice}) : super(key: key);
...
class _PaymentMethodBottomSheetState extends State<PaymentMethodBottomSheet> {
  ...
  void initState() {
    ...
    if(authProvider.isLoggedIn() && walletBalance! >= widget.totalPrice){
              ...
              builder: (ctx, orderProvider, _) {
                return Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Row(children: [
                    ...
                    configModel.walletStatus! && authProvider.isLoggedIn() && (orderProvider.partialAmount == null) ? Expanded(
                      child: PaymentButtonNew(
                        ...
                        onTap: () {
                          if(canSelectWallet) {
                            ...
                            showCustomSnackBar('${getTranslated('you_can_not_use', context)} ${getTranslated('wallet_payment', context)} ${getTranslated('in_partial_payment', context)}');
                          } else{
                            context.pop();
                    ...
                    onTap: orderProvider.paymentMethodIndex == null
                      ...
                      if(orderProvider.paymentMethod?.type == 'offline'){
                        if(orderProvider.selectedOfflineValue != null){
                          ...
                          showDialog(context: context, builder: (ctx)=> OfflinePaymentView(totalAmount: widget.totalPrice));
                        }
